...
function ImageScreenMaterial({ src }: { src: string }) {
  ...
  return <meshBasicMaterial map={imageTexture} toneMapped={false} />;
}

const isImageTexture = (src: string) => /\.(png|jpe?g|webp)$/i.test(src);
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        >
          ...
          ) : texture && isImageTexture(texture) ? (
            <ImageScreenMaterial src={texture} />
          ) : texture ? (
